...
export function BackupScreen() {
  ...
  return (
    <SettingsPage title="Backup">
      ...
      <Text variant="caption" tone="inkFaint">
        Os hábitos vivem só neste aparelho. Exportar de tempos em tempos é o que existe de rede de
        segurança — guarde o arquivo onde você não perca junto com o celular.
      </Text>
    </SettingsPage>
  );
}
